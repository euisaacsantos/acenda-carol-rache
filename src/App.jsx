...
function CTAButton({ children, className = '' }) {
  return (
    <a
      href="#investimento"
      className={`inline-block bg-gradient-to-r from-[#90660E] to-[#D8BA67] text-white font-sans font-bold uppercase tracking-wider px-10 py-5 rounded-lg hover:scale-105 hover:from-[#7A550B] hover:to-[#C8A35A] transition-all duration-300 shadow-[0_0_30px_rgba(144,102,14,0.3)] text-base md:text-base text-sm ${className}`}
    >
      {children}
    </a>
  )
...
function TattooCarousel() {
  ...
  return (
    <div
      className="relative -mt-[160px] md:-mt-[200px] z-10 pb-10 md:pb-16 w-screen left-1/2 -translate-x-1/2 overflow-hidden cursor-grab select-none"
    ...
    >
      <div ref={trackRef} className="flex gap-1.5 md:gap-2 will-change-transform">
        {tripled.map((i, idx) => (
          <div
            key={idx}
            className="flex-shrink-0 w-[200px] md:w-[280px] aspect-[4/5] rounded-md overflow-hidden shadow-lg"
          >
            <img
...
export default function App() {
  return (
    <div className="min-h-screen bg-brand-bg text-white overflow-x-hidden">
      ...
      {/* ═══════════════ HERO ═══════════════ */}
      <section className="relative py-20 md:py-16 md:bg-[url('/assets/ASLBG1DESK.png')] bg-cover bg-center bg-no-repeat">
        <div className="absolute inset-0 bg-brand-bg/70 md:bg-transparent" />
        <div className="relative max-w-[1140px] mx-auto px-4 md:px-6 text-center md:text-left">
          ...
          <h1 className="font-serif font-light text-[30px] md:text-[40px] leading-[1.0] mb-2 md:mb-4 md:max-w-[600px]">
            Você já sabe o que precisa mudar.<br />
            O problema é que ninguém te ensinou <span className="not-italic font-medium text-white">como.</span>
          </h1>
          <p className="font-sans text-lg md:text-xl font-light leading-[1.3] max-w-[800px] md:mx-0 mx-auto mb-6 md:mb-10 text-white md:max-w-[550px]">
          ...
          <div className="mt-10 flex flex-col items-center md:items-start gap-3">
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              {[
                ...
                { icon: <img src="/assets/LOGO HARVARD.svg" alt="Harvard" className="w-[140px] h-[140px]" />, text: 'Certificada em Harvard' },
              ].map(({ icon, text }) => (
                <span key={text} className="inline-flex items-center gap-2 border border-brand-gold/15 rounded-md px-3 py-1 font-sans text-xs md:text-sm text-white h-[60px] bg-black/40 backdrop-blur-md">
                  {icon}{text}
                </span>
              ))}
            </div>
      ...
      <section className="py-10 md:py-16 bg-brand-bg-light">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <h2 className="font-serif font-light text-3xl md:text-[40px] text-center mb-2 md:mb-4">
        ...
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6 text-center md:text-left">
              <h2 className="font-serif font-light text-3xl md:text-[40px] mb-2 md:mb-4">
                O problema não é você.<br /> É que ninguém te deu um <span className="italic text-gold-gradient">método.</span>
              </h2>
              <p className="font-sans text-base md:text-lg font-light text-white">
      ...
      <section className="pt-4 md:pt-6 bg-brand-bg overflow-hidden">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6 relative">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 pb-[200px] md:pb-[250px] shadow-[0_20px_60px_rgba(0,0,0,0.4)] text-center">
            {/* Ícone lâmpada */}
            ...
            <h2 className="font-serif font-light text-3xl md:text-[40px] mb-2 md:mb-4">
              ...
              as pessoas não pedem certificado. <span className="italic text-gold-gradient">Elas tatuam.</span>
            </h2>
            {/* Subtextos */}
            <p className="font-sans text-base md:text-lg font-light text-white mx-auto mb-4 whitespace-nowrap">
      ...
      <section className="py-10 md:py-16 bg-brand-bg-light">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <h2 className="font-serif font-light text-3xl md:text-[40px] text-center mb-4">
            Nos próximos 30 dias, você será acompanhada<br className="hidden md:inline" />
            diariamente, pela <span className="text-gold-gradient">Carol Rache.</span>
          </h2>
          ...
          <p className="font-sans text-base md:text-lg font-light text-center text-white mx-auto mb-10 whitespace-nowrap">
            Você não vai entrar sozinha, receber uma lista de vídeos e torcer para ter disciplina.
          </p>

          <h3 className="font-serif font-light text-2xl md:text-3xl text-center mb-8">
          ...
          <div className="relative mb-10">
            {/* Linha horizontal */}
            <div className="absolute top-[18px] left-0 right-0 h-px bg-gradient-to-r from-[#90660E] via-[#D8BA67] to-[#90660E]" />
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6 text-center">
          <h2 className="font-serif font-light text-3xl md:text-[40px] mb-4">
            Em um mês, você se transforma.<br />
            Em um ano, você transforma <span className="italic text-gold-gradient">todas as áreas da sua vida.</span>
          </h2>
          <div className="mx-auto space-y-4 mb-10">
            <p className="font-sans text-base md:text-lg font-light text-white whitespace-nowrap">
            ...
            <p className="font-sans text-base md:text-lg font-light text-white">
              E ao longo desse ano, você continua tendo encontros semanais com Carol e o time<br />
              para acompanhar cada nova fase da sua transformação.
            </p>
            <hr className="border-t border-white/10 my-6" />
            <h3 className="font-serif font-light text-2xl md:text-3xl text-center">
          ...
          {[
            ...
            <div key={idx} className="relative mb-6">
              {/* Linha vertical conectando última coluna desta linha à última da próxima */}
              ...
              {idx === 3 && (
                <div className="absolute -left-16 top-[18px] -translate-x-1/2 -translate-y-1/2 z-10">
              ...
              <div className="grid grid-cols-3 gap-6">
                {row.map((trilha) => (
                  <div key={trilha} className="flex flex-col items-center text-center">
                    ...
                    <p className="font-sans text-base md:text-lg font-bold text-white">{trilha}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="investimento" className="py-10 md:py-16 bg-brand-bg-light">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 max-w-[900px] mx-auto">
            <h2 className="font-serif font-light text-3xl md:text-[40px] text-center mb-6 md:mb-10">
            ...
            <div className="w-full max-w-[680px]">
              <div className="bg-black border-2 border-brand-gold rounded-3xl p-8 md:p-10 text-center">
                <h3 className="font-serif font-light text-3xl md:text-[40px] mb-4 whitespace-nowrap">
                ...
                <CTAButton className="w-full mt-6">Quero começar agora</CTAButton>
              </div>
            </div>
            </div>
          </div>
        ...
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left space-y-4">
              <h2 className="font-serif font-light text-3xl md:text-[40px] mb-2 md:mb-4">
                Seu investimento é <span className="text-gold-gradient">100% sem risco.</span>
              </h2>
              <p className="font-sans text-base md:text-lg font-light text-white">
      ...
      <section className="py-10 md:py-16 bg-white">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <h2 className="font-serif font-light text-3xl md:text-[40px] text-center text-brand-dark mb-2 md:mb-4">
            A mentora por trás do método:
          </h2>
          <div className="flex flex-col-reverse md:flex-row gap-4 md:gap-12 items-center">
            {/* Bio */}
            <div className="md:w-[55%] space-y-6">
              <h3 className="font-serif font-light text-[40px] md:text-[48px] text-brand-dark">Carol Rache</h3>
              <div className="space-y-4 mb-6">
                <p className="font-sans text-lg text-brand-dark/70">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-10">
            {[
              ...
              { icon: <img src="/assets/LOGO HARVARD PRETO.png" alt="Harvard" className="w-24 h-24 object-contain" />, text: <span>Certificada pela universidade<br/>mais reconhecida do mundo: Harvard</span> },
              { icon: <img src="/assets/SELO MEC.png" alt="MEC" className="w-24 h-24 object-contain" />, text: <span>Programa com certificação<br/>reconhecida pelo MEC</span> },
              { icon: <img src="/assets/LOGO FORBES.svg" alt="Forbes" className="w-24 h-24" style={{ filter: 'brightness(0)' }} />, text: 'Colunista Forbes' },
              { icon: <img src="/assets/LOGO O TEMPO.png" alt="O Tempo" className="w-24 h-24 object-contain" />, text: 'Colunista Jornal O Tempo' },
            ].map(({ icon, text }, i) => (
              <div key={i} className="font-sans text-sm text-brand-dark/70 flex items-center justify-center gap-3 border border-brand-dark/15 rounded-md px-4 py-2 h-[100px] bg-brand-dark/5 backdrop-blur-md">
      ...
      <section className="py-10 md:py-16 bg-gradient-to-b from-brand-bg-light to-brand-bg">
        <div className="max-w-[1140px] mx-auto px-4 md:px-6 text-center">
          <h2 className="font-serif font-light text-3xl md:text-[40px] mb-2 md:mb-4">
            Sua mentalidade determina<br className="md:hidden" /> sua <span className="italic text-gold-gradient">realidade.</span>
          </h2>
